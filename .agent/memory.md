...
- 2026-06-20 — CLAUDE.md split into local (project) + global (sandbox/env/Headroom/Serena, in `~/.claude`). `/session-prompt` no longer loads CLAUDE.md (auto-injected); `/codex-review` is environment-bound (seed verbatim, no project adaptation).
