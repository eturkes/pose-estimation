...
- 2026-06-22 — Adopted multi-mode session flow (MODE auto-detected from active-milestone status) + restructured roadmap into M<m>/M<m>.<u> ledger with commit trace-keys; flow specified in `/session-prompt`. (`c12ef18`)
